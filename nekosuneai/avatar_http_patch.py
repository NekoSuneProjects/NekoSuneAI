        ...
        def __init__(self, server_address, RequestHandlerClass, *args, **kwargs):
            ...
            class AvatarHandler(base_handler):
                ...
                def do_GET(self):
                    ...
                    # Serve both the historical .html URL and the clean manager URL.
                    # The page itself contains no secrets; write operations remain token-protected.
                    if path in MANAGER_ROUTES:
                        return _send_static_html(self, "avatar-upload.html")
                    # The dashboard and upload preview both use /avatar. Previously this
                    # fell through to SimpleHTTPRequestHandler and returned a raw 404 page.
