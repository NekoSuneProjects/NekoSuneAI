...
NekoSuneAI supports multiple companion profiles, each with its own personality, memory, and behaviour rules. Switch between a sarcastic best friend, a patient tutor, or a no-nonsense project manager in seconds.
...
| `companion_name` | What the AI calls itself | `"NekoSuneAI"` |
